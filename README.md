...
- `research-daily`：今日或最近 24 小时动态追踪。
- `research-weekly`：最近 7 天论文、开源项目、产品和产业信号周报。
...
- 修改 schema、模板或渲染行为后，更新 `examples/` fixture 并运行 `python3 scripts/validate_skills.py`。
